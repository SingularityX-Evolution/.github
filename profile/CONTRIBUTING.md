...
For each challenge, each contributor has one initial submission opportunity. If the initial submission is certified at Grade A, the contributor receives two additional submission opportunities for the same challenge, for a maximum of three submissions in total. Each delivered submission is an independent version and may not be changed after receipt; an additional opportunity must be used by delivering a new complete version and is counted separately.
